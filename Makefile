...
all: findTauElec makeTGraphs findAllAverages findAllAveragesDigitiser decodeEvent calculateLifetimeWithDigitiser makeFFTs findFilteredAverages resizeRawAverages makeElogEntry lookAtCathodeOnly
