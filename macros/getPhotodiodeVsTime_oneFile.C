...
void getPhotodiodeVsTime_oneFile(){

  //  string basename = "/unix/dune/purity/CERN/2019/Vacuum/PrM1/FinalConfiguration/Fibre_cleanSilvsTime/";
  string basename = "/unix/dune/purity/CERN/2019/Vacuum/PrM2/FinalConfiguration_newPreampD/Fibre_oldSilv/";
  ...
  double peak[3][300], integral[3][300], timesSec[3][300], der[3][300];
  ...
  for (int ich=0; ich<3; ich++){
      ...
      string filename = findFilename(basename, "", channels[ich]);
	...
	//	cout << it << endl;
	TGraph *g = (TGraph*)fin->Get(Form("avg100/gavg100_%i", it));
